...
if(isset($_SESSION['login']) and ($_SESSION['cat']=="1" or $_SESSION['cat']=="11" )){
...
$sd=mysqli_query($link,"SELECT * FROM date_fin order by id_date DESC ");
        ...
        $req=mysqli_query($link,"SELECT * from departement where code_depart='".$_SESSION['login']."' and statut=1 and concours=0 ");
...
<main class="main-content">
        ...
        <div class="row">
            <div class="col-12">
                <form action="choix_chef_dep.php" method="POST">
