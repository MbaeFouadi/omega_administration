...
if (isset($_SESSION['login']) and ($_SESSION['cat'] == "1" or $_SESSION['cat'] == "6" or $_SESSION['cat'] == "11")) {
    ...
    $sqlist = mysqli_query($link, "SELECT * FROM candidats where statut=5 AND retenu ='" . $_SESSION['login']. "' ORDER BY nom ASC ");
    $dep = mysqli_query($link, "SELECT * FROM departement where code_depart='" . $_SESSION['login'] . "'");
    $dat = mysqli_fetch_array($dep);
    ...
    <body>
        ...
        <section class="main-wrapper">
            ...
            <main class="main-content">
                ...
                <h2 align="center">Liste des candidats retenu en <?php echo utf8_encode($dat['design_depart']) ?> </h2>
