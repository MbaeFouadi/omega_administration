    ...
    <section class="main-wrapper">
        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-80px;color:#00b185;"> Fin de préinscription : <?php echo $dat['date_fin'];?></h5>
            ...
            <div class="text-center mb-5">
                ...
                <form action="retenu.php" method="post">
                ...
                <?php }elseif($f==1){?>
                        <div class="container">
                            ...
                            <h2 style="text-align: center;">N°:<?=$data['num_recu']?> <?=$data['nom']?>  <?=$data['prenom']?></h2><br>
                            ...
                            <form action="retenu.php" method="POST">
                                <select name="choix" class="form-control">
                                    <?php if($type==1){?>
                                            <?php if($datas['concours']==0){?>
                                                <option value="<?=$data['choix1']?>">Choix1: <?php if($datas['concours']==0){ echo utf8_encode($datas['design_depart']);} else{ echo 'Concours';}?></option>
                                            <?php }?>
                                            <?php if($dat1['concours']==0){?>
                                                <option value="<?=$data['choix2']?>">Choix2: <?php if($dat1['concours']==0){ echo utf8_encode($dat1['design_depart']);}else{ echo 'Concours';}?></option>
                                            <?php };?>
                                            <?php if($dar1['concours']==0){?>
                                                <option value="<?=$data['choix3']?>">Choix3: <?php if($dar1['concours']==0){ echo utf8_encode($dar1['design_depart']);}else{ echo 'Concours';}?></option>
                                            <?php }; ?>
