    ...
    <section class="main-wrapper">
        ...
        <h5 align="right" style="color:#00b185;"> <strong><?php echo  $_SESSION['libelle']; ?></strong></h5>
            ...
            <div class="text-center mb-5">
                <?php echo $message;?> 
 <h1 class="soft-title-1">Remplir ce champ </h1>
                ...
                <div class="col-12">
                    <form action="choixPreins.php" method="POST">
                         ...
                         <div class="form-group col-md-4"></div>
                            ...
                            <input style="text-align:center;" name="telm" type="text" class="form-control"   placeholder="Saisir le numero de reçu de l'etudiant" required >
                            </div></div>
                    </div></div>
