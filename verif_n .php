...
if(isset($_POST['submit'])){
    ...
    if(!empty($_POST['quitus'])){
        ...
        $rec=mysqli_query($link,"SELECT * FROM post_inscription,quitus WHERE post_inscription.num_auto=quitus.num_auto and num_quitus= '".$quitus."' and  post_inscription.Annee='".$_SESSION['annee']."'") or die(mysqli_error($link));     
...
$inscr=$da['num_auto']."/".$annee;
    $SqLtas=mysqli_query($link,"SELECT * FROM inscription where Num_Inscrip='$inscr'");
...
if(mysqli_num_rows($SqLtas)!=0){
    ...
    if(mysqli_num_rows($SqL)>0){
     ...
     if (isset($_POST['ok'])){ 
        ...
        $RSML=mysqli_query($link,"SELECT * FROM inscription where NIN='".$da['nin']."' and Annee='$annee' and mat_etud='$mat'");
...
<body>
    ...
    <section class="main-wrapper">
        ...
        <h4 align="right"><strong><?php  echo $_SESSION['prenom']." ".$_SESSION['nom']." "//."SELECT * FROM inscription where Num_Inscrip='$inscr'"?> </strong></h4>
        <h5 align="right" style="color:#00b185;"> <strong><?php echo  $_SESSION['libelle'].$d['intit_niv']?></strong></h5>
