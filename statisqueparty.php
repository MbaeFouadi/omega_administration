...
$nbr=0;
$dateJ=date('Y-m-d');
$map = mysqli_query($link,"SELECT * FROM type_recu");
...
$r = "SELECT * FROM candidats where id_type = '".$type."'";
$req = mysqli_query($link,$r);
$nbr = mysqli_num_rows($req); 
if(isset($_POST['valider'])){

$message = " Nombre d'etudiants préinscrits sont ".$nbr."";
       ...
       <aside class="left-aside">
        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-60px;color:#00b185;"> Fin de préinscription : <?php echo $dat['date_fin'];?></h5>
            ...
            <div class="text-center mb-5">
                ...
                <h2 align="center" class="soft-title-2" style="color:#00b185;">Nombre des préinscrits </h2>
                <hr />
                
                <form action="statisqueparty.php" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                        <select type="text" class="form-control" name="type" id="inputlib" placeholder="type recu">
											        <?php 
                              while($data = mysqli_fetch_array($map)){?>
																<option value="<?php echo $data['id_type'];?>"><?php echo $data['nom_type'];?></option>
                                          ...
                                          <h3 class="soft-title-4" style="color:green;margin-top:20%;font-family:algerian;align:center;"><?php echo $message ?></h3>					
									      <div class="text-center">
                                        <button type="submit" name="valider" class="btn btn-primary">Recherche</button>
                                        </div>
                                    </form>
