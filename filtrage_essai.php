...
$r="SELECT  date_fin FROM date_fin order by id_date DESC";
    ...
    if($_SESSION['type']==1){
        $sq= mysqli_query($link,"SELECT * FROM candidats where (choix1='".$_SESSION['dep']."' or choix2 ='".$_SESSION['dep']."' or choix3 ='".$_SESSION['dep']."') AND (id_type=1) AND retenu='".$_SESSION['dep']."'  order by nom ASC,prenom ASC");
    ...
    if($_SESSION['type']==2 || $_SESSION['type']==3){
        ...
        //$sq= mysqli_query($link,"SELECT * FROM candidats where (choix1='".$_SESSION['dep']."' or choix2 ='".$_SESSION['dep']."' or choix3 ='".$_SESSION['dep']."') AND id_type=2  order by nom ASC,prenom ASC");
        //$dat = mysqli_fetch_array($sq);
