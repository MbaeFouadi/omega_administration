    ...
    <section class="main-wrapper">
        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-60px;color:#00b185;"> Fin de préinscription : <?php echo $dat['date_fin'];?></h5>
            ...
            <div class="text-center mb-5">
                ...
                <h1 align="center" class="soft-title-2">Rechercher une autorisation de paie</h1>
                <hr />
                <h6 align="center" style="color:red;"> <?php echo $message ?></h6>
            </div>
            <div class="row">
                <div class="col-12">
                    <form action="recur_aut.php" method="POST">
                        ...
                        <div class="form-group col-md-4"></div>
                           ...
                           <label for="inputNin">Nin</label>
                                ...
                                <input style="text-align:center;" type="text" name="nin" class="form-control"  placeholder="Saisir le Nin">
                            </div>
