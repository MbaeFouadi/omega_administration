...
$r5 = "SELECT * FROM candidats WHERE  id_type=5";
$req5 = mysqli_query($link,$r5);
$nbr5 = mysqli_num_rows($req5); 

$traitant6=$_SESSION['login'];
$r6 = "SELECT * FROM candidats WHERE  id_type=6";
$req6 = mysqli_query($link,$r6);
$nbr6 = mysqli_num_rows($req6); 

$traitant7=$_SESSION['login'];
$r7 = "SELECT * FROM candidats WHERE  id_type=7";
$req7 = mysqli_query($link,$r7);
$nbr7 = mysqli_num_rows($req7); 
$caisse5 = $nbr5 * 5000;
$caisses=$caisse1+$caisse2+$caisse3+$caisse4+$caisse5;
$nbres=$nbr1+$nbr2+$nbr3+$nbr4+$nbr5+$nbr6+$nbr7 ;
  // echo $r; 
   //echo "\t"; var_dump($nbr);
...
<div class="text-right">
        ...
        <h6 style="margin-left:10px;margin-top:20px;"  align=center><STRONG>Nombre de préinscrits par type de préinscription</STRONG>&nbsp;</h6> 
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th> Préinscription L2</th>
                                    <td><?php echo $nbr2 ?></td>
                                   
                                
                                </tr>
                                 <tr>
                                    <th> Préinscription L3</th>
                                    <td><?php echo $nbr3 ?></td>
