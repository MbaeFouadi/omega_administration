...
if($_SESSION['type']==3  || $_SESSION['type']==4){
    ...
    AND (
        ...
        candidats.traitant_recu=users.login AND 
        (id_type='3' or id_type='4') AND id_ile='1'
    AND (
        candidats.choix1 ='".$_SESSION['dep']."'
        OR candidats.choix2 ='".$_SESSION['dep']."'
        OR candidats.choix3 ='".$_SESSION['dep']."'
...
if($_SESSION['ile']=="A"){
    ...
    AND (
        ...
        $sqlist1= mysqli_query($link,"SELECT candidats.nom as nom, candidats.prenom as prenom, nin, num_recu, date_naiss,lieu_naiss FROM candidats,users where 
        candidats.traitant_recu=users.login AND 
        (id_type='3' or id_type='4') AND id_ile='2'
    AND (
        candidats.choix1 ='".$_SESSION['dep']."'
        OR candidats.choix2 ='".$_SESSION['dep']."'
        OR candidats.choix3 ='".$_SESSION['dep']."'
                    ...
                    <table class="table table-striped table-bordered tableexcel" id="tablexcel">
                        <thead class="thead-dark">
                            ...
                            while($datlist = mysqli_fetch_array($sqlist)){
                                ...
                                // $math_s=$datlist['anglais_sec'];
                                // $math_p=$datlist['anglais_pre'];
                                // $math_t=$datlist['anglais_tle'];
                                // $math_b=$datlist['anglais_bac'];
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $datlist['nin']; ?></td>
                                            <td><?= $datlist['nom']; ?></td>
                                            <td><?= $datlist['prenom']; ?></td>
                                            <td><?= $datlist['date_naiss']; ?></td>
                                            <td><?= $datlist['lieu_naiss']; ?></td>
                                            <td><?= $math_moy ?></td>
