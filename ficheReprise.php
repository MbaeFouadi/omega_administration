                ...
                <div class="container">
                        ...
                        <div class="row" style="margin-top:20px">
                            ...
                            <div  class="col-md-8" >
                                ...
                                <h4 style="margin-left:-130px"> <strong>FICHE DE REPRISE DES ETUDES<br></strong></h4><h5 style="margin-left:30px">(Année <?php echo $d."-".$dd  ?>)</h5>
                    ...
                    <h5 >Raison de la reprise d'etudes: </h5>
                        ...
                        <h6  style="margin-top:-100px"><b><strong>Piéces à fournir</strong>:<br>-photocopie du relevé des notes annuelles justifiant le niveau d'études acquis</b></h6>
                        <div class="border-top"></div>
