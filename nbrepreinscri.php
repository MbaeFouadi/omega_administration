...
elseif(isset($_SESSION['login']) and ($_SESSION['cat']=="1" or $_SESSION['cat']=="2" or $_SESSION['cat']=="7" or $_SESSION['cat']=="5" )){
    ...
    <section class="main-wrapper">
        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-60px;color:#00b185;"> Fin de préinscription : <?php echo $dat['date_fin'];?></h5>
            ...
            <div class="text-center mb-5">
                ...
                <h2 align="center" class="soft-title-2" style="color:#00b185;">Nombre de préinscrits </h2>
                <hr />
                <h3 align="center"  class="soft-title-4" style="color:green;margin-top:20%;font-family:algerian;"> Nombre d'etudiants préinscrits sont <?php echo $nbr ?> </h3>
            </div>
