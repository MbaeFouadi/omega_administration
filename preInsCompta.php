...
$r="SELECT  * FROM date_fin WHERE type=1 order by id_date DESC";
...
$statut=$_POST['choix'];
 ...
 switch($statut){
    case "option1":header('location:bacAv.php'); break; 
    case "option2":header('location:nouve.php'); break; 
    case "option3":header('location:bacAv.php'); break; 
...
<body>
    ...
    <section class="main-wrapper">
        ...
        <p align="center"> <?php echo (date('d-m-Y'))?></p>
                ...
                <h1 align="center" class="soft-title-2">Préinscrire un etudiant</h1>
                <hr />
            </div>
            <div class="row" style="margin-top:100px;margin-left:50px;">
                <div class="col-12">
                    <form action="preInsCompta.php" method="POST">
                    ...
                    <label class="form-check-label" for="inlineRadio2">Bac après 2010</label>
                    </div>
                    <div class="form-check form-check-inline">
