...
if(isset($_POST['submit'])){
   ...
   // $debut=$_POST['date1'];
    ...
    $r="INSERT INTO date_fin (date_fin,type) values ('$fin_ins','2')";

    $req = mysqli_query($link,$r);
    $nbr = mysqli_affected_rows($link);
     if($nbr!=0){
    //
            $m="Vous venez de fixer le ".$fin_ins."  comme date de fin des inscriptions ";
    ...
    <section class="main-wrapper">
        ...
        <h5 align="right" style="color:#00b185;"> <strong><?php echo  $_SESSION['libelle']; ?></strong></h5>
            ...
            <div class="text-center mb-5">
                ...
                <h2 class="soft-title-2" align="center" style="color:#00b185;">Fin des inscriptions</h2>
                <hr/>
...
<h3 class="soft-title-4" align="center" style="margin-top:50px;margin-bottom:20px;">Veuillez indiquer la date!</h3>
            ...
            <form action="fixation_fin_ins.php" method="POST">
            <div class="form-row">
