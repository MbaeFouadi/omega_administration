...
if(isset($_POST['submit'])){
    ...
    $requete =mysqli_query($link,"SELECT  * FROM quitus WHERE  num_auto = '$auto' AND Annee ='".$_SESSION['annee']."'");
    if (mysqli_num_rows($requete)!=0) {
        ...
        $m="Cet etudiant a déjà un quitus ";
         ...
         $t=0;
          $_SESSION['auto']=$_POST['num_auto'];
          $_SESSION['code_niv']=$_POST['code_niv'];
                     header('location:pre_quitus.php');
...
?>
            ...
            <div class="text-center mb-5">
                ...
                <form action="verif_auto.php" method="post">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <h5 style='margin-left:-90px,margin-right:20px'>Niveau: &nbsp;<b><?php echo utf8_encode($data1['intit_niv']) ?></b></h5>
                        </div>
