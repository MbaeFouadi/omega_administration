...
<div class="row">
    <div class="col-12">
        <form action="choix_dep_ins.php" method="POST">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="faculte2" class="form-control" name="faculte2">
                        ...
                        <?php 
                            if($_SESSION['type']==5){
                                $pics = mysqli_query($link,"SELECT DISTINCT design_facult,faculte.code_facult  FROM faculte,departement,disposition where faculte.code_facult=departement.code_facult and departement.code_depart=disposition.code_depart and code_niv='N5' and disposition.statut=1 and departement.statut=1 ");
                                
                               
                            } elseif($_SESSION['type']==4){
                                $pics = mysqli_query($link,"SELECT DISTINCT design_facult,faculte.code_facult  FROM faculte,departement,disposition where faculte.code_facult=departement.code_facult and departement.code_depart=disposition.code_depart and code_niv='N4' and disposition.statut=1 and departement.statut=1 ");
                                
                            }
                            elseif($_SESSION['type']==3){
                                $pics = mysqli_query($link,"SELECT DISTINCT design_facult,faculte.code_facult  FROM faculte,departement,disposition where faculte.code_facult=departement.code_facult and departement.code_depart=disposition.code_depart and (code_niv='N3'or code_niv='P3')  and disposition.statut=1 and departement.statut=1 ");
                                
                            }
                            elseif($_SESSION['type']==2){
                                $pics = mysqli_query($link,"SELECT DISTINCT design_facult,faculte.code_facult  FROM faculte,departement,disposition where faculte.code_facult=departement.code_facult and departement.code_depart=disposition.code_depart and (code_niv='N2'or code_niv='P2')  and disposition.statut=1 and departement.statut=1 ");

                            } elseif($_SESSION['type']==1){
                                $pics = mysqli_query($link,"SELECT DISTINCT design_facult,faculte.code_facult  FROM faculte,departement,disposition where faculte.code_facult=departement.code_facult and departement.code_depart=disposition.code_depart and (code_niv='N1'or code_niv='P1')  and disposition.statut=1 and departement.statut=1 ");                                
                            }
                           
                        while($dat=mysqli_fetch_array($pics)){?>

                        <option value="<?php echo $dat['code_facult'];?>" data-concour="<?php echo $data['concours'];?>"><?php echo utf8_encode($dat['design_facult']);?></option>
